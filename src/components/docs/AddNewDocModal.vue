...
import NetworkConnectionStatusAlert from '@/components/ui/NetworkConnectionStatusAlert.vue'
...
<template>
  <div class="overflow-auto fixed z-50 bg-white rounded fade-modal absolute-center">
    <div class="relative py-12 px-4 sm:px-6 w-full h-full">
      ...
      <NetworkConnectionStatusAlert
        v-if="NetworkConnectionStatus[networkConnectionStatus] !== 'connected'"
      />
      <div v-else>
