<template>
  <div>
    <span v-if="(url || '').includes('/document/')" class="logo-link">
      <svg alt="Google" class="rounded" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 64.000000 64.000000" preserveAspectRatio="xMidYMid meet">
        <rect x="5" y="5" width="55" height="55" fill=white></rect>
        <g transform="translate(0.000000,64.000000) scale(0.100000,-0.100000)" :fill="colorOverride || '#4285F4'" stroke="none">
    ...
    <span v-if="(url || '').includes('/spreadsheets/')" class="logo-link">
      <svg alt="Google" class="rounded" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 64.000000 64.000000" preserveAspectRatio="xMidYMid meet">
        <rect x="5" y="5" width="55" height="55" fill="white"></rect>
        <g transform="translate(0.000000,64.000000) scale(0.100000,-0.100000)" :fill="colorOverride || '#0F9D58'" stroke="none">
    ...
    <span v-if="(url || '').includes('/presentation/')" class="logo-link">
      <svg alt="Google" class="rounded" xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 64.000000 64.000000" preserveAspectRatio="xMidYMid meet">
        <rect x="5" y="5" width="55" height="55" fill="white"></rect>
        <g transform="translate(0.000000,64.000000) scale(0.100000,-0.100000)" :fill="colorOverride || '#F4B400'" stroke="none">
