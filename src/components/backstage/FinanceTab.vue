...
<template>
  <div class="text-center">
    ...
    <button
      title="Approve"
      class="inline-block py-1 px-4 btn-white min-w-[7rem]"
    >
      Trade 🡕
    </button>
    <h4 class="mt-8 mb-2">Revenue</h4>
    <small class="text-grey3"
      >Generated by sponsored posts and tips commission (20%)</small
    >
    ...
    <div v-if="selectedRevType === 'Yours'">
      ...
      <button
        title="Pay out"
        class="inline-block py-1 px-4 mt-2 mb-6 btn-white min-w-[7rem]"
      >
        Pay out
      </button>
    </div>
    <h5>- To date -</h5>
    <strong
      >{{ revenueData[selectedRevType.toLowerCase()].toDate.usd }} USD</strong
    >
    <p
